...
import { ItemContainer, HeadContainer, Image, InputLabels, TitleObj, FootContainer, ColaborateRectangles } from "./itemCard.styled";
            ...
            <HeadContainer>
                ...
                <TitleObj>
                    ...
                    <InputLabels>
                        ...
                        <InputNumber min={1} value={count} onChange={setValue} className="InputField"/>
                    </InputLabels>
                </TitleObj>
            </HeadContainer>
            <FootContainer>
